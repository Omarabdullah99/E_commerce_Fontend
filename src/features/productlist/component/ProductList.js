...
const ProductList = () => {
  ...
  const products = useSelector(selectAllProducts); //*get all products
  const brands = useSelector(selectAllBrands); //*get all brands
  const categories = useSelector(selectAllCategory); //*get all category
  const totalItems=useSelector(selectTotalItems) //*get total products items
  const staus= useSelector(selectProductListStatus)
  console.log('productListstaus',staus)
  ...
  //*this useEffect for fetch all products
  // useEffect(()=>{
...
//*this useEffect for filter,sort,pagination
  useEffect(() => {
  ...
  //*this useEffect for filtersoptions show
  
  return (
    <div className="bg-white">
      <div>
        {/* Mobile filter dialog start */}
        <MobileFilter mobileFiltersOpen={mobileFiltersOpen} setMobileFiltersOpen={setMobileFiltersOpen} filter={filter} handleFilter={handleFilter} filters={filters} ></MobileFilter>
          ...
          <section aria-labelledby="products-heading" className="pb-24 pt-6">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-4">
              ...
              <div className="lg:col-span-3">
                <ProductGrid products={products} staus={staus}></ProductGrid>
              </div>
...
function ProductGrid({products,staus}) {
  return(
    <div className="bg-white">
