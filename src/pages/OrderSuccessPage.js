...
function OrderSuccessPage() {
    ...
    //* order successfull hole cart resetCart hoye jabe
    useEffect(()=>{
      //*reset cart
      dispatch(resetCartAsync(user?.result?.id))
      //*reset order
      dispatch(resetOrder())
    ...
    return ( 
        ...
        <div className="text-center">
          ...
          <p className="mt-6 text-base leading-7 text-gray-600">You can check your order in My Account then My Orders</p>
